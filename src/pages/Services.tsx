            ...
            <div className='h-screen flex flex-col'>
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    <main className="flex-1 overflow-y-auto p-6 mt-20">
                            ...
                            <button onClick={()=> setOpenServiceForm(!openServiceForm)} className="absolute right-3 top-27 cursor-pointer transition hover:scale-105">Agregar Servicio</button>
                            <div className="flex flex-wrap gap-y-10 gap-x-10 mt-10 w-full md:flex-row">
                                {services.map((service)=>{
                                    return (
                                        <div key={service.id} className="bg-white w-70 h-40 p-3 rounded-xl flex flex-col md:w-70 transition hover:shadow-lg hover:scale-102">
